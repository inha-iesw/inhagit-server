...
public class AssistantApproveController {
    ...
    public BaseResponse<String> demotionStudent(@Validated @RequestBody AssistantDemotionRequest assistantDemotionRequest) {
        return BaseResponse.of(ASSISTANT_PROMOTION_CANCEL_OK, adminApproveService.demotionStudent(assistantDemotionRequest));
    }
