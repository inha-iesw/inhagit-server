...
public enum ErrorStatus implements BaseErrorCode {
    ...
    FILE_MAX_SIZE(HttpStatus.BAD_REQUEST, "FILE4005", "압축 파일의 총 크기는 500MB 이하로 제한됩니다."),
    ...
    NOT_ALLOWED_VIEW_SUBMITS_PROBLEM(HttpStatus.BAD_REQUEST, "PROBLEM4030", "출제자만 해당 문제 제출 목록을 볼 수 있습니다."),
    DUPLICATE_PROBLEM_SUBMISSION(HttpStatus.BAD_REQUEST, "PROBLEM4031", "이미 제출한 문제입니다."),
    ...
    NOT_EXIST_PROJECT_STAR(HttpStatus.BAD_REQUEST, "PROJECT_STAR4000", "존재하지 않는 프로젝트 Star 게시글입니다."),
    ALREADY_REGISTERED_STAR(HttpStatus.BAD_REQUEST, "PROJECT_STAR4001", "이미 존재하는 Star 게시글입니다."),
