...
public enum SuccessStatus implements BaseCode {
    ...
    PROJECT_STAR_ACCEPT_OK(HttpStatus.CREATED, "ADMIN2023", "프로젝트 Star 승인 성공"),
    PROJECT_STAR_ACCEPT_CANCEL_OK(HttpStatus.CREATED, "ADMIN2024", "프로젝트 Star 승인 취소 성공"),
    ...
    PROBLEM_REQUEST_OK(HttpStatus.CREATED, "PROBLEM2011", "문제 참여 성공"),
    PROBLEM_REQUEST_UPDATE_OK(HttpStatus.OK, "PROBLEM2012", "문제 참여 수정 성공"),
    PROBLEM_REQUEST_DELETE_OK(HttpStatus.OK, "PROBLEM2013", "문제 참여 삭제 성공"),
    PROBLEM_REQUEST_SEARCH_OK(HttpStatus.OK, "PROBLEM2004", "문제 신청 전체 조회 성공"),
    PROBLEM_REQUEST_DETAIL_OK(HttpStatus.OK, "PROBLEM2005", "문제 신청 상세 조회 성공"),
    PROBLEM_PARTICIPANT_STATE_CHANGE_OK(HttpStatus.OK, "PROBLEM2006", "문제 참여 상태 변경 성공"),
    ...
    PROBLEM_SUBMIT_OK(HttpStatus.CREATED, "PROBLEM2014", "문제 제출 성공"),
    PROBLEM_SUBMIT_SEARCH_OK(HttpStatus.OK, "PROBLEM2008", "문제 제출 조회 성공"),
    ...
    MY_PAGE_PROBLEM_PARTICIPATING_SEARCH_OK(HttpStatus.OK, "USER2008", "마이페이지 참여중인 문제 조회 성공"),
