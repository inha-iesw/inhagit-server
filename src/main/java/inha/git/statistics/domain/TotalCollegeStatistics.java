...
/**
 * TotalCollegeStatistics 엔티티는 애플리케이션의 전체 통계 정보를 나타냄.
 */
...
@Builder
@Entity
@Table(name = "total_college_statistics_tb")
public class TotalCollegeStatistics {

    @Id
    @Column(name = "total_college_statistics_id")
